...
(cl:defmethod cl:initialize-instance :after ((m <imu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'imu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imu_node-msg:<imu> is deprecated: use imu_node-msg:imu instead.")))
...
(cl:defmethod accelx-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:accelx-val is deprecated.  Use imu_node-msg:accelx instead.")
  (accelx m))

(cl:ensure-generic-function 'accely-val :lambda-list '(m))
(cl:defmethod accely-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:accely-val is deprecated.  Use imu_node-msg:accely instead.")
  (accely m))

(cl:ensure-generic-function 'accelz-val :lambda-list '(m))
(cl:defmethod accelz-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:accelz-val is deprecated.  Use imu_node-msg:accelz instead.")
  (accelz m))

(cl:ensure-generic-function 'gyrox-val :lambda-list '(m))
(cl:defmethod gyrox-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:gyrox-val is deprecated.  Use imu_node-msg:gyrox instead.")
  (gyrox m))

(cl:ensure-generic-function 'gyroy-val :lambda-list '(m))
(cl:defmethod gyroy-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:gyroy-val is deprecated.  Use imu_node-msg:gyroy instead.")
  (gyroy m))

(cl:ensure-generic-function 'gyroz-val :lambda-list '(m))
(cl:defmethod gyroz-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:gyroz-val is deprecated.  Use imu_node-msg:gyroz instead.")
  (gyroz m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:pitch-val is deprecated.  Use imu_node-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:roll-val is deprecated.  Use imu_node-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:yaw-val is deprecated.  Use imu_node-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'rawstr-val :lambda-list '(m))
(cl:defmethod rawstr-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:rawstr-val is deprecated.  Use imu_node-msg:rawstr instead.")
  (rawstr m))

(cl:ensure-generic-function 'capturetime-val :lambda-list '(m))
(cl:defmethod capturetime-val ((m <imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader imu_node-msg:capturetime-val is deprecated.  Use imu_node-msg:capturetime instead.")
  (capturetime m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <imu>) ostream)
  ...
  (cl:let ((__sec (cl:floor (cl:slot-value msg 'capturetime)))
        (__nsec (cl:round (cl:* 1e9 (cl:- (cl:slot-value msg 'capturetime) (cl:floor (cl:slot-value msg 'capturetime)))))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <imu>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((__sec 0) (__nsec 0))
      ...
      (cl:setf (cl:slot-value msg 'capturetime) (cl:+ (cl:coerce __sec 'cl:double-float) (cl:/ __nsec 1e9))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<imu>)))
  ...
  "1e735649411ccab8314d71bfa2b8a46c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'imu)))
  "Returns md5sum for a message object of type 'imu"
  "1e735649411ccab8314d71bfa2b8a46c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<imu>)))
  ...
  (cl:format cl:nil "Header header~%~%float64 accelx~%float64 accely~%float64 accelz~%float64 gyrox~%float64 gyroy~%float64 gyroz~%float64 pitch~%float64 roll~%float64 yaw~%string  rawstr~%time    capturetime~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'imu)))
  "Returns full string definition for message of type 'imu"
  (cl:format cl:nil "Header header~%~%float64 accelx~%float64 accely~%float64 accelz~%float64 gyrox~%float64 gyroy~%float64 gyroz~%float64 pitch~%float64 roll~%float64 yaw~%string  rawstr~%time    capturetime~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
