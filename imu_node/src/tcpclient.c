...
static int tcpclient_buffer_write(tcpclient_t* cli,
...
static void set_block_mode(tcpclient_t* cli)
{
    int flag = 0;
...
int tcpclient_read(tcpclient_t* cli,
...
int tcpclient_error(tcpclient_t* cli, char* error_message, int max_size)
{
    (void)cli;
    (void)error_message;
    (void)max_size;
